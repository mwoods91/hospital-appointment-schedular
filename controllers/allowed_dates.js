...
exports.getAllAllowedDates = async (req, res) => {
  try {
...
// get all custom dates from the database
exports.getAllowedDatesByHospital = async (req, res) => {
  try {
    const { id } = req.body;
    if (!id) {
...
exports.createAllowedDates = async (req, res) => {
  try {
...
exports.updateAllowedDatesById = async (req, res) => {
  try {
...
exports.deleteAllowedDatesById = async (req, res) => {
  try {
    const { id } = req.body;
    // Check if any required field is missing
    if (!id) {
...
exports.deleteAllAllowedDates = async (req, res) => {
  try {
